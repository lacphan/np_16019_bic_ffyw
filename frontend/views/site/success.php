        ...
        <div class="registration-content">
            <div class="success-content">
                ...
                <div class="content a-center">
                    ...
                    <p><?=  Html::a(Yii::t(_NP_TEXT_DOMAIN, '*' . 'Click here for Official Rules'), Yii::$app->urlManager->createUrl(['page/show-single','slug' => 'official-rules']),['target' => '_self','class' => 'color-1'])?></p>
                </div>
