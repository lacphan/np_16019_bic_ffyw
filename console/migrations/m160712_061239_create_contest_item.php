...
class m160712_061239_create_contest_item extends Migration
{
    ...
    public function up()
    {
        ...
        $this->addForeignKey('FK_ContestItem_Attachment','{{%contest_item}}', 'attachment_id', '{{%attachment}}', 'id', 'NO ACTION', 'NO ACTION');
        ...
        $this->insert('{{%contest_item}}', [
            'id' => 2,
            'start_date' => '2016-08-09 00:00:00',
    ...
    {
        $this->dropForeignKey('FK_ContestItem_Attachment','{{%contest_item}}');
